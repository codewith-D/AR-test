...
function setupGeometry() {
    ...
    navigationArea.add(createWallElement(new THREE.Vector3( 10, -1.5, -2.75), new THREE.Vector3(0, 0, 0), new THREE.Vector3(-30, 3, -0.4)));
    navigationArea.add(createWallElement(new THREE.Vector3( 10, -1.5, 2.65), new THREE.Vector3(0, 0, 0), new THREE.Vector3(-30, 3, -0.4)));
    //navigationArea.add(createWallElement(new THREE.Vector3(4, -1.5, 0), new THREE.Vector3(0, 0, 0), new THREE.Vector3(1, 1, 1)));
    ...
    navigationArea.position.set(5, 0, 0);
